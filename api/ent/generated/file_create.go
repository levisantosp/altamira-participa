...
func (_c *FileCreate) SetIssueID(v int64) *FileCreate {
...
func (_c *FileCreate) SetIssue(v *Issue) *FileCreate {
...
func (_c *FileCreate) check() error {
	if _, ok := _c.mutation.IssueID(); !ok {
		return &ValidationError{Name: "issue_id", err: errors.New(`generated: missing required field "File.issue_id"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
	...
	if len(_c.mutation.IssueIDs()) == 0 {
		return &ValidationError{Name: "issue", err: errors.New(`generated: missing required edge "File.issue"`)}
	}
	return nil
}
