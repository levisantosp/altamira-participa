...
func (_q *FileQuery) QueryIssue() *IssueQuery {
...
func (_q *FileQuery) WithIssue(opts ...func(*IssueQuery)) *FileQuery {
	query := (&IssueClient{config: _q.config}).Query()
...
func (_q *FileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*File, error) {
	...
	if query := _q.withIssue; query != nil {
		if err := _q.loadIssue(ctx, query, nodes, nil,
			func(n *File, e *Issue) { n.Edges.Issue = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *FileQuery) loadIssue(ctx context.Context, query *IssueQuery, nodes []*File, init func(*File), assign func(*File, *Issue)) error {
...
func (_q *FileQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withIssue != nil {
			_spec.Node.AddColumnOnce(file.FieldIssueID)
		}
	}
